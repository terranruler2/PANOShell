...
.NOTES
  ...
  Derivative Work Author: Justin Grote (jgrote@allieddigital.net)
  Date  : 2017/01/04
  Vers  : 1.7

  Updates:
  2017/01/104
        - Updated Functions to Powershell Approved Verbs
        - Removed some Validations to allow ImportModule in PS5 to work
        -
  2012/10/13
...
#>
	...
	if(0 -ne $Results)
	{
	    ...
	    write-verbose "Successfully saved $Target to Windows Credential Store"
    }
}
